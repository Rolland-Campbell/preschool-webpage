...
const routes = [
  ...
  },
  {
    ...
    // which is lazy-loaded when the route is visited.
    component: function () {
      return import(/* webpackChunkName: "parentHandbook" */ '../views/ParentHandbook.vue')
    }
  },
  {
    path: '/daily-schedule',
  ...
  },
  {
    ...
    // which is lazy-loaded when the route is visited.
    component: function () {
      return import(/* webpackChunkName: "meetUs" */ '../views/MeetUs.vue')
    }
  }
]
