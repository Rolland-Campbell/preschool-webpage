<template>
  <main class="parentHandbook container-fluid">
    <div class="row">
      <div class="col-2 owlAdj">
        <img src="../assets/owl2.png" class="owlPic" />
      </div>
      <div class="col-8 handbookText mt-5">
        <p>
          <u>
        ...
        <p>New Years Day, Memorial Day, 4th of July, Labor Day, Thanksgiving Day and the Friday after, Christmas Eve, and Christmas Day.</p>
      </div>
    </div>
    <div class="row">
      <div id="accordion" class="col-12 col-md-8 offset-md-2 mt-5">
        <div class="card">
          <div
            class="card-header"
            id="headingOne"
        ...
        <div class="card mt-2">
          ...
          <div id="collapseFive" class="collapse">
            <div class="card-body">
              <p>Under no circumstances may a parent bring a sick child to the TreeHouse. Idaho State law requires that a child be removed from the learning center if a child shows the following signs of illness:</p>
              <dl>
                <li>Diarrhea</li>
        ...
        <div class="card mt-2">
          ...
          <div id="collapseSeven" class="collapse">
            <div class="card-body">
              <p>Families are charged a daily rate of $25. You are welcome to take vacations through out the year, just add up the number of days your child will be in our care and multiply by $25.</p>
